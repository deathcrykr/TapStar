...
namespace CodeStage.AntiCheat.Time
{
	...
	public class SpeedHackProofTime : KeepAliveBehaviour<SpeedHackProofTime>
	{
		...
		/// </summary>
		/// This property mimics Time.timeScale but ensures changes go through the SpeedHackDetector's
		/// safe API to avoid false positives when timeScale detection is enabled.
		public static float timeScale
		{
			...
			set
			{
				Detectors.SpeedHackDetector.SetTimeScale(value);
			}
		}

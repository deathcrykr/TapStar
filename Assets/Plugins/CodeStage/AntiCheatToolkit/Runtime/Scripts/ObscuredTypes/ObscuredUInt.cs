...
{
	/// <summary>
	/// Use it instead of regular <c>uint</c> for any cheating-sensitive properties, fields and other long-term declarations.
	/// </summary>
	...
	public partial struct ObscuredUInt : IObscuredType
	{
		...
		[NonSerialized] internal uint fakeValue;
		...
		{
			if (IsDefault()) this = new ObscuredUInt(default);
		...
		private static bool ValidateHash(uint input, int hash)
		{
#if DEBUG
		...
		private void HideValue(uint plain)
		{
		...
		/// </summary>
		public static uint DecryptFromV0(uint value, uint key)
		{
			return value ^ key;
		}

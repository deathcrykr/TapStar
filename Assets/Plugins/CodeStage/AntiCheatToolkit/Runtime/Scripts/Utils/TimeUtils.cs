...
namespace CodeStage.AntiCheat.Utils
{
	...
	internal static class TimeUtils
	{
		...
		/// <summary>
		/// Gets speed hacks unbiased current time in seconds.
		/// </summary>
		/// <returns>Reliable current time in seconds (same scale as Time.realtimeSinceStartup).</returns>
		public static double GetReliableSeconds()
		{
			return GetReliableTicks() / (double)TicksPerSecond;
		}

...
namespace CodeStage.AntiCheat.Common
{
	...
	public static class ACTk
	{
		...
		public const string DocsRootUrl = "https://docs.codestage.net/actk/api/";
		...
		private static string ConstructErrorForSupport(string text, string prefix = null, Exception exception = null)
		{

...
namespace CodeStage.AntiCheat.Storage
{
	...
	public static partial class ObscuredFilePrefs
	{
		...
		public static void Set(string key, ObscuredDateTime value) { Set<DateTime>(key, value); }
		public static void Set(string key, ObscuredDateTimeOffset value) { Set<DateTimeOffset>(key, value); }
		public static void Set(string key, ObscuredDecimal value) { Set<decimal>(key, value); }
		public static void Set(string key, ObscuredBigInteger value) { Set<System.Numerics.BigInteger>(key, value); }
		...
		public static void Set(string key, ObscuredGuid value) { Set<Guid>(key, value); }
		...
		public static ObscuredDateTime Get(string key, ObscuredDateTime defaultValue = default) { return Get<DateTime>(key, defaultValue); }
		public static ObscuredDateTimeOffset Get(string key, ObscuredDateTimeOffset defaultValue = default) { return Get<DateTimeOffset>(key, defaultValue); }
		public static ObscuredDecimal Get(string key, ObscuredDecimal defaultValue = default) { return Get<decimal>(key, defaultValue); }
		public static ObscuredBigInteger Get(string key, ObscuredBigInteger defaultValue = default) { return Get<System.Numerics.BigInteger>(key, defaultValue); }
		...
		public static ObscuredGuid Get(string key, ObscuredGuid defaultValue = default) { return Get<Guid>(key, defaultValue); }
